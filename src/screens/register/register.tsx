    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          onChangeText={setCpf}
          placeholder="Seu CPF"
          keyboardType="numeric" // Sugere um teclado numérico
        />
      </View>
      <View style={styles.inputContainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          keyboardType="email-address" // Sugere um teclado com @ e .
        />
      </View>
      <View style={styles.inputContainer}>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 20,
    backgroundColor: '#F8F8F8', // Um tom de fundo mais claro
  ...
  button: {
    backgroundColor: '#007AFF', // Um azul chamativo para o botão
    padding: 15,
    borderRadius: 5,
    alignItems: 'center',
  },
